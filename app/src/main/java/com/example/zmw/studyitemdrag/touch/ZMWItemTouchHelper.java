 ...
 * {@link ZMWItemTouchHelper.Callback} class or implementing {@link ZMWItemTouchHelper.ViewDropHandler}
 * interface in your LayoutManager.
 * <p/>
 * By default, ZMWItemTouchHelper moves the items' translateX/Y properties to reposition them. On
 * platforms older than Honeycomb, ZMWItemTouchHelper uses canvas translations and View's visibility
 ...
 */
public class ZMWItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    /**
     * ZMWItemTouchHelper is in idle state. At this state, either there is no related motion event by
    ...
    /**
     * Set when ZMWItemTouchHelper is assigned to a RecyclerView.
     */
    ...
    /**
     * Developer callback which controls the behavior of ZMWItemTouchHelper.
     */
    Callback mCallback;
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent event) {
            ...
            if (action == MotionEvent.ACTION_DOWN) {
                ...
                if (mSelected == null) {
                    ...
                    if (animation != null) {
                        mInitialTouchX -= animation.mX;//view的横向偏移量
                        mInitialTouchY -= animation.mY;//view的纵向偏移量
    ...
    /**
     * Creates an ZMWItemTouchHelper that will work with the given Callback.
     * <p/>
     * You can attach ZMWItemTouchHelper to a RecyclerView via
     * {@link #attachToRecyclerView(RecyclerView)}. Upon attaching, it will add an item decoration,
     * an onItemTouchListener and a Child attach / detach listener to the RecyclerView.
     *
     * @param callback The Callback which controls the behavior of this touch helper.
     */
    public ZMWItemTouchHelper(Callback callback) {
        mCallback = callback;
    }
    ...
    /**
     * Attaches the ZMWItemTouchHelper to the provided RecyclerView. If TouchHelper is already
     * attached to a RecyclerView, it will first detach from the previous one. You can call this
     * method with {@code null} to detach it from the current RecyclerView.
     *
     * @param recyclerView The RecyclerView instance to which you want to add this helper or
     *                     {@code null} if you want to remove ZMWItemTouchHelper from the current
     *                     RecyclerView.
     */
    ...
    private void initGestureDetector() {
        ...
        mGestureDetector = new GestureDetectorCompat(mRecyclerView.getContext(),
                new ZMWItemTouchHelperCallbackGestureListener());
    }
    ...
    /**
     * Starts dragging the provided ViewHolder. By default, ZMWItemTouchHelper starts a drag when a
     * View is long pressed. You can disable that behavior by overriding
     * {@link ZMWItemTouchHelper.Callback#isLongPressDragEnabled()}.
     * <p/>
     ...
     * ZMWItemTouchHelper
     * is attached.</li>
     * <li>{@link ZMWItemTouchHelper.Callback} must have dragging enabled.</li>
     * <li>There must be a previous touch event that was reported to the ZMWItemTouchHelper
     ...
     *                 mZMWItemTouchHelperCallback.startDrag(viewHolder);
     *             }
     *             return false;
     *         }
     *     });
     ...
     *                   RecyclerView.
     * @see ZMWItemTouchHelper.Callback#isItemViewSwipeEnabled()
     */
    public void startDrag(RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            Log.e(TAG, "Start drag has been called with a view holder which is not a child of "
                    + "the RecyclerView which is controlled by this ZMWItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0f;
    ...
    /**
     * Starts swiping the provided ViewHolder. By default, ZMWItemTouchHelper starts swiping a View
     * when user swipes their finger (or mouse pointer) over the View. You can disable this
     * behavior
     * by overriding {@link ZMWItemTouchHelper.Callback}
     * <p/>
     * For this method to work:
     * <ul>
     * <li>The provided ViewHolder must be a child of the RecyclerView to which this
     * ZMWItemTouchHelper is attached.</li>
     * <li>{@link ZMWItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ZMWItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events, this should work as expected.</li>
     * </ul>
     ...
     *         public boolean onTouch(View v, MotionEvent event) {
     *             if (MotionEventCompat.getActionMasked(event) == MotionEvent.ACTION_DOWN) {
     *                 mZMWItemTouchHelperCallback.startSwipe(viewHolder);
     *             }
     *             return false;
     *         }
     *     });
    ...
    public void startSwipe(RecyclerView.ViewHolder viewHolder) {
        ...
        if (viewHolder.itemView.getParent() != mRecyclerView) {
            Log.e(TAG, "Start swipe has been called with a view holder which is not a child of "
                    + "the RecyclerView controlled by this ZMWItemTouchHelper.");
            return;
        }
        obtainVelocityTracker();
        mDx = mDy = 0f;
     ...
     * {@link ZMWItemTouchHelper}.
     */
    public static interface ViewDropHandler {

        /**
         * Called by the {@link ZMWItemTouchHelper} after a View is dropped over another View.
         * <p/>
    ...
    /**
     * This class is the contract between ZMWItemTouchHelper and your application. It lets you control
     ...
     * {@link SimpleCallback}.
     * <p/>
     * If user drags an item, ZMWItemTouchHelper will call
     ...
     * custom drop target.
     * <p/>
     * When a View is swiped, ZMWItemTouchHelper animates it until it goes out of bounds, then calls
    ...
    public abstract static class Callback {
         ...
         * swiping.
         *
         * @param recyclerView The RecyclerView to which ZMWItemTouchHelper is attached.
         ...
         *
         * @param recyclerView The RecyclerView to which ZMWItemTouchHelper is attached to.
        ...
        /**
         * Called when ZMWItemTouchHelper wants to move the dragged item from its old position to
         * the new position.
         * <p/>
         * If this method returns true, ZMWItemTouchHelper assumes {@code viewHolder} has been moved
        ...
        /**
         * Returns whether ZMWItemTouchHelper should start a drag and drop operation if an item is
         * long pressed.
         * <p/>
         * Default value returns true but you may want to disable this if you want to start
         * dragging on a custom view touch using {@link #startDrag(RecyclerView.ViewHolder)}.
         *
         * @return True if ZMWItemTouchHelper should start dragging an item when it is long pressed,
        ...
        /**
         * Returns whether ZMWItemTouchHelper should start a swipe operation if a pointer is swiped
         * over the View.
         * <p/>
         * Default value returns true but you may want to disable this if you want to start
         * swiping on a custom view touch using {@link #startSwipe(RecyclerView.ViewHolder)}.
         *
         * @return True if ZMWItemTouchHelper should start swiping an item when user swipes a pointer
        ...
        /**
         * When finding views under a dragged view, by default, ZMWItemTouchHelper searches for views
         ...
         * dragged. After a view is moved this amount, ZMWItemTouchHelper starts checking for Views
         ...
         * Keep in mind that ZMWItemTouchHelper also checks the perpendicular velocity and makes sure
        ...
        /**
         * Defines the maximum velocity ZMWItemTouchHelper will ever calculate for pointer movements.
         * <p/>
         * To consider a movement as swipe, ZMWItemTouchHelper requires it to be larger than the
         ...
         *
         * @param defaultValue The default value(in pixels per second) used by the ZMWItemTouchHelper.
        ...
        /**
         * Called by ZMWItemTouchHelper to select a drop target from the list of ViewHolders that
         ...
         * <p/>
         * ZMWItemTouchHelper will keep a reference to the View until it is detached from
         * RecyclerView.
         * As soon as it is detached, ZMWItemTouchHelper will call
        ...
        /**
         * Called when the ViewHolder swiped or dragged by the ZMWItemTouchHelper is changed.
         * <p/>
         * If you override this method, you should call super.
         *
         * @param viewHolder  The new ViewHolder that is being swiped or dragged. Might be null if
         *                    it is cleared.
         * @param actionState One of {@link ZMWItemTouchHelper#ACTION_STATE_IDLE},
         *                    {@link ZMWItemTouchHelper#ACTION_STATE_SWIPE} or
         *                    {@link ZMWItemTouchHelper#ACTION_STATE_DRAG}.
         * @see #clearView(RecyclerView, RecyclerView.ViewHolder)
         */
        public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
            if (viewHolder != null) {
                sUICallback.onSelected(viewHolder.itemView);//隐藏掉
            }
        }
         ...
         * <p/>
         * ZMWItemTouchHelper does not create an extra Bitmap or View while dragging, instead, it
         ...
         *
         * @param recyclerView The RecyclerView controlled by the ZMWItemTouchHelper.
        ...
        private void onDraw(Canvas c, RecyclerView parent, RecyclerView.ViewHolder selected,
            ...
            for (int i = 0; i < recoverAnimSize; i++) {
                final ZMWItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
        ...
        /**
         * Called by the ZMWItemTouchHelper when the user interaction with an element is over and it
         ...
         *
         * @param recyclerView The RecyclerView which is controlled by the ZMWItemTouchHelper.
        ...
        /**
         * Called by ZMWItemTouchHelper on RecyclerView's onDraw callback.
         * <p/>
         ...
         * <code>dY</code>.
         * ZMWItemTouchHelper also takes care of drawing the child after other children if it is being
        ...
        /**
         * Called by the ZMWItemTouchHelper when user action finished on a ViewHolder and now the View
         ...
         *
         * @param recyclerView  The RecyclerView to which the ZMWItemTouchHelper is attached to.
        ...
        /**
         * Called by the ZMWItemTouchHelper when user is dragging a view out of bounds.
         * <p/>
         ...
         *
         * @param recyclerView        The RecyclerView instance to which ZMWItemTouchHelper is
         *                            attached to.
     ...
     * <p/>
     * <pre>
     * ZMWItemTouchHelper mIth = new ZMWItemTouchHelper(
     *     new ZMWItemTouchHelper.SimpleCallback(ZMWItemTouchHelper.UP | ZMWItemTouchHelper.DOWN,
     *         ZMWItemTouchHelper.LEFT) {
     *         public abstract boolean onMove(RecyclerView recyclerView,
    ...
    private class ZMWItemTouchHelperCallbackGestureListener extends GestureDetector.SimpleOnGestureListener {
